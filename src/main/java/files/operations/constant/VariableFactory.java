...
public class VariableFactory {
    ...
    public ConstantNum variable(String name, int value) {
        ConstantNum constantNum = new ConstantNum(new ScInt(value), name);
        hashTable.put(name, constantNum);
        return constantNum;
    }

    public ConstantNum variable(String name, float value) {
        ConstantNum constantNum = new ConstantNum(new ScFloat(value), name);
        hashTable.put(name, constantNum);
        return constantNum;
    }
    ...
    public Constant variable(String name, String value) {
        if (value.matches("^[01]+$")) {
            ConstantNum constantNum = new ConstantNum(new ScBinary(value), name);
            hashTable.put(name, constantNum);
            return constantNum;
        }
        else {
    ...
    public ConstantLogical variable(String name, boolean value) {
        ConstantLogical constantLogical = new ConstantLogical(new ScBoolean(value), name);
    ...
    public Operations variable(String name, Operations value) {
        ...
        return value;
        // return new Pair<String,Operations>(name, value);
    }
