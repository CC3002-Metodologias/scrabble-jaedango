...
public class ScIntTest {
    ...
    protected int n1 = r1.nextInt() % 1000;
    protected int n2 = r2.nextInt() % 1000;
    protected int n3 = r3.nextInt() % 1000;
    ...
    void addScStringTest() {
        ...
        ScString expected1 = new ScString(a + n1);
        ScString expected2 = new ScString(b + n2);
        ScString expected3 = new ScString(c + n3);
    ...
    void addScBinaryTest() {
        ...
        String exp1 = intToBin(n1 + num1);
        String exp2 = intToBin(n1 + num2);
        String exp3 = intToBin(n2 + num1);
        String exp4 = intToBin(n2 + num2);
        var expected1 = new ScBinary(exp1);
        var expected2 = new ScBinary(exp2);
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = int1.addToBin(bin1);
        ScBinary actual2 = int1.addToBin(bin2);
        ScBinary actual3 = int2.addToBin(bin1);
        ScBinary actual4 = int2.addToBin(bin2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void addBinaryTest() {
        ...
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = (ScBinary) bin1.add(int1);
        ScBinary actual2 = (ScBinary) bin2.add(int1);
        ScBinary actual3 = (ScBinary) bin1.add(int2);
        ScBinary actual4 = (ScBinary) bin2.add(int2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void subScBinaryTest() {
        ...
        var bin1 = new ScBinary(intToBin(num1));
        var bin2 = new ScBinary(intToBin(num2));
        String exp1 = intToBin(num1 - n1);
        String exp2 = intToBin(num2 - n1);
        String exp3 = intToBin(num1 - n2);
        String exp4 = intToBin(num2 - n2);
        var expected1 = new ScBinary(exp1);
        var expected2 = new ScBinary(exp2);
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = int1.subToBin(bin1);
        ScBinary actual2 = int1.subToBin(bin2);
        ScBinary actual3 = int2.subToBin(bin1);
        ScBinary actual4 = int2.subToBin(bin2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void subBinaryTest() {
        ...
        String exp3 = intToBin(num1 - n2);
        String exp4 = intToBin(num2 - n2);
        ScBinary expected1 = new ScBinary(exp1);
        ScBinary expected2 = new ScBinary(exp2);
        ScBinary expected3 = new ScBinary(exp3);
        ScBinary expected4 = new ScBinary(exp4);
        ScBinary actual1 = (ScBinary) bin1.sub(int1);
        ScBinary actual2 = (ScBinary) bin2.sub(int1);
        ScBinary actual3 = (ScBinary) bin1.sub(int2);
        ScBinary actual4 = (ScBinary) bin2.sub(int2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void mulScBinaryTest() {
        ...
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = int1.mulToBin(bin1);
        ScBinary actual2 = int1.mulToBin(bin2);
        ScBinary actual3 = int2.mulToBin(bin1);
        ScBinary actual4 = int2.mulToBin(bin2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void mulBinaryTest() {
        ...
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = (ScBinary) bin1.mul(int1);
        ScBinary actual2 = (ScBinary) bin2.mul(int1);
        ScBinary actual3 = (ScBinary) bin1.mul(int2);
        ScBinary actual4 = (ScBinary) bin2.mul(int2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void divScBinaryTest() {
        ...
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = int1.divToBin(bin1);
        ScBinary actual2 = int1.divToBin(bin2);
        ScBinary actual3 = int2.divToBin(bin1);
        ScBinary actual4 = int2.divToBin(bin2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void divBinaryTest() {
        ...
        var expected3 = new ScBinary(exp3);
        var expected4 = new ScBinary(exp4);
        ScBinary actual1 = (ScBinary) bin1.div(int1);
        ScBinary actual2 = (ScBinary) bin2.div(int1);
        ScBinary actual3 = (ScBinary) bin1.div(int2);
        ScBinary actual4 = (ScBinary) bin2.div(int2);
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
