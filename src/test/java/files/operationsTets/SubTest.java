...
public class SubTest {
    ...
    void subIntTest() {
        ...
        Constant actual1 = new Sub(cn1, cn2).eval();
        Constant actual2 = new Sub(cn1, new Sub(cn1, cn2)).eval();
        Constant actual3 = new Sub(new Sub(cn1, cn2), cn2).eval();
        Constant actual4 = new Sub(new Sub(cn1, cn2), new Sub(cn2, cn1)).eval();
    ...
    void subFloatTest() {
        ...
        Constant actual1 = new Sub(cf1, cf2).eval();
        Constant actual2 = new Sub(cf1, new Sub(cf1, cf2)).eval();
        Constant actual3 = new Sub(new Sub(cf1, cf2), cf2).eval();
        Constant actual4 = new Sub(new Sub(cf1, cf2), new Sub(cf2, cf1)).eval();
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void subBinaryTest() {
        ...
        Constant actual1 = new Sub(cb1, cb2).eval();
        Constant actual2 = new Sub(cb1, new Sub(cb1, cb2)).eval();
        Constant actual3 = new Sub(new Sub(cb1, cb2), cb2).eval();
        Constant actual4 = new Sub(new Sub(cb1, cb2), new Sub(cb2, cb1)).eval();
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
    ...
    void mixedTest() {
        ...
        Constant actual1 = new Sub(cn1, cf1).eval();
        Constant actual2 = new Sub(cn2, cb1).eval();
        Constant actual3 = new Sub(cb1, cn2).eval();
        Constant actual4 = new Sub(cn1, new Sub(cn2, cf1)).eval();
        Constant actual5 = new Sub(new Sub(cn1, cb1), new Sub(cb2, cn2)).eval();
        assertEquals(expected1, actual1);
        assertEquals(expected2, actual2);
        assertEquals(expected3, actual3);
        assertEquals(expected4, actual4);
