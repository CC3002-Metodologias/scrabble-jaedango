...
public class DivTest {
    ...
    void divIntTest() {
        ...
        var expected4 = c.cNum(n.getScInt((num1 / num2) / (num1 / num1)));
    ...
    void divBinaryTest() {
        ...
        var expected4 = c.cNum(n.getScBinary(intToBin((num4 / num3) / (num3 / num4))));
    ...
    void mixedTest() {
        ...
        var expected5 = c.cNum(n.getScBinary(intToBin((num3 / num1) / (num2 / num4))));
